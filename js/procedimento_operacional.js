  let currentUser = null;
        ...
        function loadDocuments() {
            ...
            function filterDocuments() {
                ...
                // Se o campo de busca estiver vazio, mostra todos os documentos
                if (searchText.trim() === '') {
                    renderDocuments(allDocuments);
                    return;
                }
                
                // Filtra os documentos que correspondem à pesquisa
                ...
                if (filteredDocs.length === 0) {
                    container.innerHTML = `
                        <div class="empty-state">
                            ...
                            <p>Não há documentos que correspondam à sua pesquisa.</p>
                        </div>
                    `;
                } else {
