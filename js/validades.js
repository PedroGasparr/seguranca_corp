...
async function moveToDisableCollection() {
    ...
    const confirmMove = confirm(`Tem certeza que deseja mover ${selectedDocuments.length} documento(s) para la coleção de desativados?\n\nEsta ação não pode ser desfeita.`);
...
// Adicionar estilos para o novo status
...
style.textContent = `
    ...
    /* Estilos para o novo status "A vencer" */
    .status-badge.a-vencer {
        background-color: #ff9800;
        color: white;
    }
    
    .status-value.a-vencer {
        background-color: #ff9800;
        color: white;
    }
